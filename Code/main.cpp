...
#define greenb 14   // (3) on the trafficlight
#define orangeb 32  // (2) on the trafficlight
#define redb 13     // (1) on the trafficlight

// pins for the pedestrian lights
#define greenp 26   // (5) on the trafficlight
#define redp 27     // (4) on the trafficlight
